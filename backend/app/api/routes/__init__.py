...
from app.api.routes.profile_target_calculations import router as profile_target_calculations_router
...
api_router.include_router(profile_target_calculations_router)
